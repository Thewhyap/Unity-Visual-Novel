...
namespace COMMANDS
{
    public class CommandManager : MonoBehaviour
    {
        ...
        private CoroutineWrapper ExecuteSubCommand(string commandName, string[] args)
        {
            ...
            if(subDatabases.ContainsKey(databaseName))
            {
                ...
                if (command != null)
                {
                    ...
                    Debug.LogError($"No command called '{subCommandName}' was found");
                    return null;
                }
            }
        ...
        private CoroutineWrapper ExecuteCharacterCommand(string commandName, params string[] args)
        {
            ...
            Debug.LogError($"Command Manager was unable to execute command '{commandName}'");
            return null;
        }
        ...
        private IEnumerator WaitingForProcessToComplete(Delegate command, string[] args)
        {
            ...
            else if (command is Func<string, IEnumerator>) yield return ((Func<string, IEnumerator>)command)(args[0]);
        ...
        public CommandDatabase CreateSubDataBase(string name)
        {
            ...
            {
                Debug.LogWarning($"A Database with name '{name}' already exists !");
                return db;
            }
