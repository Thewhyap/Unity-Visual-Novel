...
namespace COMMANDS
{
    public class CMD_DatabaseExtension_Characters : CMD_DatabaseExtension
    {
        ...
        new public static void Extend(CommandDatabase database)
        {
            ...
            //Add commands to specific character types
        ...
        public static void SetPriority(string[] data)
        {
            ...
            if (!int.TryParse(data[1], out int priority)) priority = 0;
        ...
        public static IEnumerator SetColor(string[] data)
        {
            ...
            { //TODO sometimes character != null and sometimes character?. in the code + inline variables
        ...
        public static IEnumerator Unhighlight(string[] data)
        {
            ...
            if (immediate) character.Highlight(immediate: false);
            else
            {
                CommandManager.instance.AddTerminationActionToCurrentProcess(() => { character?.Highlight(immediate: false); });
                yield return character.Highlight();
            }
        }
        ...
        public static IEnumerator SetSprite(string[] data)
        {
            ...
            if (immediate) character.GetSprite(spriteName);
            else
            {
